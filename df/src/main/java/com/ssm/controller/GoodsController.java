...
//	}
	...
	public String toshowdetail(HttpSession session,HttpServletResponse response,@PathVariable int regex1,Model model,@CookieValue(value = "review",required=false)String review) {
