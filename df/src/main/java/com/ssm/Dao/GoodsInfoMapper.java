...
public interface GoodsInfoMapper {
	...
	public List<GoodsInfo> viewlist1(@Param(value = "gtype_id") int gtype_id, @Param(value = "type") String type,
			@Param(value = "page") int page);

	public List<GoodsInfo> viewlist(@Param(value = "gtype_id") int gtype_id, @Param(value = "type") String type,
			@Param(value = "page") int page, @Param(value = "up") String up);
